...
<div class="login">
    ...
    <form class="login form" action="/login/recuperar-conta/email/codigo/senha" method="POST">
        {{csrf_field()}}

        <div class="form-group">
            <p class="parag">Nova Senha:</p>
            <input type="text" name="newPassword" placeholder="Insira sua Nova Senha" class="form-control">
        </div>

        <div class="form-group">
            <input type="hidden" name="idHidden" value="{{$userId}}" class="btn btn-login">
        </div>
        ...
        <div class="form-group">
            <a href="/">
                <i class="fas fa-arrow-left voltar-recuperar-senha"></i>
            </a>
        </div>
